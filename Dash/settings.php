...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <h1 class="page-header">Dashboard | <small>Settings</small></h1>
            <h4>Change Password</h4>
              <form class="form" method="post">
                ...
                <input type="password" placeholder="Re-enter Password" name="newpassword2" required/>
                <button class="btn btn-primary" name="changepassword">Confirm</button>
                <br><br>
